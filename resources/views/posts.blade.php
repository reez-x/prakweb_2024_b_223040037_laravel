<x-layout>
    ...
    {{-- <article class="py-8 max-w-screen-md border-b border-grey-300">
        ...
        <div >
            ...
            in
            <a href="/categories/{{ $post->category->slug }}" class="text-base text-gray-500">{{ $post->category->name }}</a> | {{ $post->created_at->diffForHumans()}}
        </div>
    ...
    <div>
        ...
        <a href="/posts" class="block text-blue-600 hover:underline">&laquo; Back to all psts</a>
    </div>
    @endforelse
</div>  
</div>
